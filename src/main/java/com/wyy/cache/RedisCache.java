package com.wyy.cache;

import com.wyy.base.BaseMapper;
import com.wyy.utils.ProtoStuffSerializerUtil;
...
//	}
	...
	public <T> List<T> cacheList(String cache_key, Class<T> t, Map<Object , Object>  paramMap, BaseMapper<T> dao, Logger LOG){
		...
		if (result_cache != null) {
			...
			LOG.info(result_cache.toString()+","+paramMap+","+dao.toString());
			boolean flag = putListCacheWithExpireTime(cache_key, result_cache, RedisCache.CAHCETIME);
			//System.out.println(flag);
			if(flag)	LOG.info("put cache with key:" + cache_key);
			return result_cache;
		}
		return result_cache;
	}
